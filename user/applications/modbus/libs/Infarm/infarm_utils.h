...
#define DEBUG(fmt, ...) fa_serial_debug(FA_LOG_LEVEL_DEBUG, fmt, ##__VA_ARGS__)
#define INFO(fmt, ...) fa_serial_debug(FA_LOG_LEVEL_INFO, fmt, ##__VA_ARGS__)
#define ERROR(fmt, ...) fa_serial_debug(FA_LOG_LEVEL_INFO, fmt, ##__VA_ARGS__)

#define MILLIS_IN_MINUTE 60UL * 1000UL
